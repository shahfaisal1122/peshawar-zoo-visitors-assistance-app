...
class AnimalDetails extends StatelessWidget {
  ...
  final String
      image; // This should be the local file path if offline, or a base64 string if on web
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color.fromARGB(255, 7, 87, 153), // Blue color
              Color.fromARGB(255, 0, 0, 0), // Black color
            ],
  ...
  // Display the image based on the platform and format
